...
const TEX_WOOD = 'https://raw.githubusercontent.com/Voyagers-hook/images/refs/heads/main/wood%20texture.png';
const TEX_PARCHMENT = 'https://raw.githubusercontent.com/Voyagers-hook/images/refs/heads/main/parchment.png';
const TEX_RIVET = 'https://raw.githubusercontent.com/Voyagers-hook/images/refs/heads/main/rivet.png';
...
export default function CollectionBookClient() {
  ...
  return (
    <>
      {/* ══════════════════════════════════════════════════════════════
          OUTER WOOD FRAME — wraps everything
      ══════════════════════════════════════════════════════════════ */}
      <div className="relative rounded-2xl overflow-hidden"
        ...
        {/* Inner bevel highlight on wood frame */}
        ...
        {/* ══════════════════════════════════════════════════════════════
            PARCHMENT PAGE — where the cards sit
        ══════════════════════════════════════════════════════════════ */}
